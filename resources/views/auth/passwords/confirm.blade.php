...
@section('title')
    Confirmation du mot de passe &bullet; Compte
@endsection
            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-2">Confirmation du mot de passe</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.confirm') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100 mb-3" type="submit">Confirmer le mot de passe</button>
                            </div>
                        </form>
