                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted">Ajouter un pays</p>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row row-cols-1 row-cols-md-3 g-4 mb-3">
                                    <div class="col-md-8">
                                        <p>Détails du pays</p>                                 
                                        <div>
                                            <form id="formAccountSettings" method="POST" action="{{ route('countries.store') }}">
                                                @csrf
                                                <div class="row">                                            
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea class="form-control" name="description" id="editorPacks" placeholder="Description du pays...">{!! old('description') !!}</textarea>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <p class="text-muted">*Exemples de shortern</p>                                 
