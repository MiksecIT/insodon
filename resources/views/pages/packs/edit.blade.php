                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted">Modification du pack</p>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="publish" id="publish" {{ $pack->is_available ? 'checked' : '' }}/>
