                            ...
                            <div class="card-body">
                                <div class="row row-cols-1 row-cols-md-3 g-4 mb-3">
                                    <div class="col-md-12">
                                        <p>Détails du FAQ</p>                                 
                                        <div>
                                            <form id="formAccountSettings" method="POST" action="{{ route('faqs.store') }}">
                                                @csrf
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <textarea class="form-control" name="content" id="" cols="30" rows="10" placeholder="Contenu du FAQ..."></textarea>
                                                        </div>
                                                    </div>
